...
export default function Itinerary() {
  return (
    <div className="hax-body">
      <h1 className="title">Itinerary of HAX 2022</h1>
            ...
            <div class="timeline__wrapper">
              ...
              <div class="timeline__block">
                ...
                <div class="timeline__block__head">
                  <h1 class="timeline__block__title">Friday, April 22nd</h1>
                </div>
                <div class="timeline__block__body">
                  <p class="timeline__block__text">
                    Meet in ECEB 4072 and 3001
                  </p>
                </div>
              </div>
              <div class="timeline__block">
                ...
                <div class="timeline__block__body">
                  <p class="timeline__block__text">
                    Kickoff in 3001! (explanation of schedule and how to make a
                    project proposal)
                  </p>
                </div>
              </div>
              ...
              <div class="timeline__block">
                ...
                <div class="timeline__block__head">
                  <h1 class="timeline__block__title">Saturday, April 23rd</h1>
                </div>
                <div class="timeline__block__body">
                  <p class="timeline__block__text">
                    Meet in ECEB 4072 and 3001
              ...
              <div class="timeline__block">
                ...
                <div class="timeline__block__body">
                  <p class="timeline__block__text">
                    Proposal review and Office Hours (3001)
                  </p>
                </div>
              </div>
              <div class="timeline__block">
              ...
              <div class="timeline__block">
                ...
                <div class="timeline__block__head">
                  <h1 class="timeline__block__title">Sunday, April 24th</h1>
                </div>
                <div class="timeline__block__body">
                  <p class="timeline__block__text">
                    Meet in ECEB 4072 and 3001 for 7:00am-7:00pm reservation
                  </p>
                </div>
              </div>
              <div class="timeline__block">
              ...
              <div class="timeline__block">
                ...
                <div class="timeline__block__body">
                  <p class="timeline__block__text">
                    Projects due!! Judge panel rates projects.
                  </p>
                </div>
              </div>
              <div class="timeline__block">
